...
<!--	<div class="content_wrap nav_bg">
	...
	<div class="content_wrap intro_bg">
		<div class="content clearfix">
            <div class="grid">
                <div class="grid-24">
                    <h1><i class="fa fa-phone"></i> Contact</h1>
		...
		<div class="content clearfix">
            <div class="grid">
                <div class="grid-24">
                    ...
                    <h2><i class="fa fa-list-alt"></i> The Feature List</h2>
                    <div class="frame">
                    <h3><i class="fa fa-edit"></i> Flexibility and Customisation</h3>
                    ...
                    <h3><i class="fa fa-database"></i> Database Structure</h3>
                    <div class="frame_note">
                        <ul class="bullet">
                    ...
                    <h3><i class="fa fa-user-plus"></i> User Registration</h3>
                    <div class="frame_note">
                        <ul class="bullet">
                    ...
                    <h3><i class="fa fa-sign-in"></i> User Login Methods</h3>
                    <div class="frame_note">
                        <ul class="bullet">
                    ...
                    <h3><i class="fa fa-unlock-alt"></i> CAPTCHAs</h3>
                    <div class="frame_note">
                    ...
                    <h3><i class="fa fa-lock"></i> Password Security</h3>
                    <div class="frame_note">
                        <ul class="bullet">
                    ...
                    <h3><i class="fa fa-lock"></i> General Security</h3>
                    <div class="frame_note">
                        <ul class="bullet">
                            <li>
                    ...
                    <h3>Two Different Purpose Libraries</h3>
                    <div class="frame_note">
